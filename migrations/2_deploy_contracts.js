...
module.exports = async (deployer, network, [bank, foundation]) => {
  ...
  const davCap = web3.toWei(708571429);
  ...
  await deployer.deploy(DAVCrowdsale, rate, bank, foundation, DAVToken.address, weiCap, davCap, minimalContribution, maximalIndividualContribution, openingTime, openingTimeB, closingTime);
};
